...
class LSTMmodel():
    ...
    def __init__(self,data_range=0.08,max_len=10,min_len=1,min_number=2) -> None:
    ...
    def model_compile(self,optimizer='rmsprop',loss='categorical_crossentropy',metrics=['accuracy'],sample_weight_mode='temporal')->tf.keras.Model:   
